...
class Run {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Run_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * - Run_i18n. Defines internationalization functionality.
	 * - Run_Admin. Defines all hooks for the admin area.
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-run-i18n.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-run-public.php';
	 ...
	 *
	 * Uses the Run_i18n class in order to set the domain and to register the 
	 * hook with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Run_Public( $this->get_plugin_name(), $this->get_version() );
