(function($) {
	...
	inlineEditPost.edit = function( id ) {
		...
		edit_row.querySelector('input[name="run_duration"]').value = run_duration;
		...
		// set the run steps
		edit_row.querySelector('input[name="run_steps"]' ).value = run_steps;
		...
		if ( ! isNaN(run_calories) ) {
			...
			edit_row.querySelector('input[name="run_calories"]').value = run_calories;
		}
	};
